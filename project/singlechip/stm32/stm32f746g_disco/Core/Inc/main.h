...
#define IMAGE_COLOR_R		0xF800
#define IMAGE_COLOR_G		0x07E0
#define IMAGE_COLOR_B		0x001F
#define USART_READ_TIMEOUT      1000
#define USART_READ_START	0x334455
#define USART_READ_CRC		0x554433
#define AI_IM_C			3
#define AI_OUTPUT_DIME		1 * 7 * 7
#define AI_OUTPUT_LAYER		3
#define AI_OUTPUT_CAL		18
#define AI_OUTPUT_CAL_SIZE	6
#define AI_OUTPUT_CAL_CON	4
#define AI_PER			-9
#define AI_SCALE_INDEX		15
#define AI_SCALE_OFFSET		0.14218327403068542f
#define AI_SAMPLIN		8
struct usart_data {
	uint32_t st;
