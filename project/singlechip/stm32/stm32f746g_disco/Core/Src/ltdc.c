...
{
  extern uint8_t img_data[sizeof(struct usart_data)];
  ...
  hltdc.Init.Backcolor.Blue = 123;
  hltdc.Init.Backcolor.Green = 222;
  hltdc.Init.Backcolor.Red = 55;
  if (HAL_LTDC_Init(&hltdc) != HAL_OK)
  {
    Error_Handler();
  }
  pLayerCfg.WindowX0 = (480/2) - (56 / 2);
  pLayerCfg.WindowX1 = (480/2) + (56 / 2);
  pLayerCfg.WindowY0 = (272 / 2) - (56 / 2);
  pLayerCfg.WindowY1 = (272 / 2) + (56 / 2);
  pLayerCfg.PixelFormat = LTDC_PIXEL_FORMAT_RGB565;
  pLayerCfg.Alpha = 255;
  pLayerCfg.Alpha0 = 0;
  pLayerCfg.BlendingFactor1 = LTDC_BLENDING_FACTOR1_PAxCA;
  pLayerCfg.BlendingFactor2 = LTDC_BLENDING_FACTOR2_PAxCA;
  pLayerCfg.FBStartAdress = (uint32_t)img_data + sizeof(uint32_t);
  pLayerCfg.ImageWidth = 56;
  pLayerCfg.ImageHeight = 56;
  pLayerCfg.Backcolor.Blue = 123;
  pLayerCfg.Backcolor.Green = 222;
  pLayerCfg.Backcolor.Red = 55;
